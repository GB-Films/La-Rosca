...
export const QuestionCard = ({ question, showAnswer, letter }: QuestionCardProps) => (
  <section className="host-question-card rounded-lg border border-line bg-panel p-2.5 sm:p-5">
    ...
    <div className="host-question-text mt-2 sm:mt-4">
    ...
    {showAnswer && (
      <div className="host-answer-box mt-2 rounded-md border border-emerald-400/30 bg-emerald-500/10 p-2 sm:mt-4 sm:p-3">
